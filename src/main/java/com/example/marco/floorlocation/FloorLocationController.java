...
public class FloorLocationController {
    ...
    @PutMapping
    public FloorLocationEntity upsertFloorLocationEntity(@RequestBody FloorLocationEntity inFloorLocationEntity) throws Exception{
        return this.floorLocationService.upsertFloorLocationEntity(inFloorLocationEntity);
    }
